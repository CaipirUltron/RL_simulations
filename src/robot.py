...
class Robot:
    ...
    def get_neighbors(self):
        ...
        observation[0] = window[1,2]		#angle 0
        observation[1] = window[0,2]		#angle 45
        ...
        self.neighbors = np.roll(observation, obs_roll)		#garante que observation[0] a sempre o que esta a frente do robot
    ...
    # Go forward
    def go_forward(self):			#usar estas para qlearning
        self.sim_dynamics(0)
